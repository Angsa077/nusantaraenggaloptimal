                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('adminmanajemenuser.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="name" class="form-control" name="name"
                                                                value="{{ $data->name }}" placeholder="Silahkan Masukan Nama Lengkap">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="email" id="email" class="form-control" name="email"
                                                                value="{{ $data->email }}" placeholder="Silahkan Masukan Email">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="nip" class="form-control" name="nip"
                                                                value="{{ $data->nip }}" placeholder="Silahkan Masukan NIP">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="nik" class="form-control" name="nik"
                                                                value="{{ $data->nik }}" placeholder="Silahkan Masukan NIK">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="npwp" class="form-control" name="npwp"
                                                                value="{{ $data->npwp }}" placeholder="Silahkan Masukan NPWP">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="no_hp" class="form-control" name="no_hp"
                                                                value="{{ $data->no_hp }}" placeholder="Silahkan Masukan No HP">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="alamat" class="form-control" name="alamat"
                                                                value="{{ $data->alamat }}" placeholder="Silahkan Masukan Alamat Tinggal Saat Ini">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="tp_lahir" class="form-control" name="tp_lahir"
                                                                value="{{ $data->tp_lahir }}" placeholder="Silahkan Masukan Tempat Lahir">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('profile.updated') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="profile_photo_path" class="col-md-4 col-form-label text-md-right">{{ __('Profile Photo') }}</label>

                                <div class="col-md-6">
                                    <input id="profile_photo_path" type="file" class="form-control @error('profile_photo_path') is-invalid @enderror" name="profile_photo_path" value="{{ old('profile_photo_path') }}" accept="image/*">
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-md-6">
                                    <input id="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') ?? $user->no_hp }}" required autocomplete="no_hp">
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    placeholder="Silahkan Masukan Password Untuk Menyimpan Perubahan!">

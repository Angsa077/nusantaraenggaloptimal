    ...
    <div class="main-content container-fluid mt-5">
        <section id="multiple-column-form">
            <div class="row match-height">
                ...
                @if ($penjualan->status_pengiriman == 'dikirim' || $penjualan->status_pengiriman == 'selesai')
                    <div class="col-4">
                        <div class="card">
                            <div class="card-header">
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="tgl_pengiriman" class="form-control"
                                                            name="tgl_pengiriman" value="{{ $data->tgl_pengiriman }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="nama_penerima" class="form-control" value="{{ $data->nama_penerima }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tgl_sampai" class="form-control"
                                                        name="tgl_sampai" value="{{ $data->tgl_sampai }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="catatan" class="form-control" value="{{ $data->catatan }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

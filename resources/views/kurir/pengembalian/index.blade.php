            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        <table class="table table-hover" id="myTable">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr
                                        onclick="window.location='{{ route('kurir.pengembalian.edit', $item->kd_pengembalian) }}';">
                        ...
                        <div class="col-3 col-md-3 order-md-2 order-last"> <a href="{{ route('kurir.pengembalian.create') }}"

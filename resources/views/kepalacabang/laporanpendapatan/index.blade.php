            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        ...
                        <form method="GET" action="{{ route('kepalacabanglaporanpendapatan.index') }}"
                            ...
                            <div class="d-flex justify-content-end ml-2">
                                <a href="{{ route('kepalacabanglaporanpendapatan.pdf', ['tanggal_awal' => $tanggalAwal, 'tanggal_akhir' => $tanggalAkhir]) }}"

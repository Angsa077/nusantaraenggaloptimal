                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('kepalacabang.manajemenuser.update', $data->id) }}" method="POST"
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="name" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan Nama Lengkap" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" id="email" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan Email" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="nip" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan NIP" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="nik" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan NIK" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="npwp" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan NPWP" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="no_hp" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan No HP" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="tp_lahir" class="form-control"
                                                            ...
                                                            placeholder="Silahkan Masukan Tempat Lahir" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" id="tg_lahir" class="form-control"
                                                            name="tg_lahir" value="{{ $data->tg_lahir }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" id="tgl_masuk" class="form-control"
                                                            name="tgl_masuk" value="{{ $data->tgl_masuk }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" id="tgl_keluar" class="form-control"
                                                            name="tgl_keluar" value="{{ $data->tgl_keluar }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="id_admin" class="form-control"
                                                            name="id_admin" value="{{ $data->user->name }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

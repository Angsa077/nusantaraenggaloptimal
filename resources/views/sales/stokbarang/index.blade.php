            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        ...
                        <form method="GET" action="{{ route('salesstokbarang.index') }}" class="form-inline mb-3">
                            <div class="d-flex justify-content-end ml-2">
                                <a href="{{ route('salesstokbarang.pdf') }}" class="btn btn-secondary"><i
                        ...
                        <table class="table table-hover" id="myTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($data->unique('kd_barang') as $item)
                                    ...
                                    @endphp
                                    <tr onclick="window.location='{{ route('salesbarang.show', $item->kd_barang) }}';">

                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="total_harga" class="form-control"
                                                        ...
                                                        value="{{ 'Rp ' . number_format($penjualan->total_harga, 2, ',', '.') }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="total_bayar" class="form-control"
                                                        ...
                                                        value="{{ 'Rp ' . number_format($penjualan->total_bayar, 2, ',', '.') }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="position-relative">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="sisa_bayar" class="form-control"
                                                        ...
                                                        value="{{ 'Rp ' . number_format($sisa_bayar, 2, ',', '.') }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

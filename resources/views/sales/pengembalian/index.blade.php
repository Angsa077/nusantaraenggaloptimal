                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-left text-md"><a href="{{ route('salespengembalian.show', $item->kd_pengembalian) }}"
                                                class="btn"><i data-feather="send"></i></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        <div class="col-3 col-md-3 order-md-2 order-last"> <a href="{{ route('salespengembalian.create') }}"

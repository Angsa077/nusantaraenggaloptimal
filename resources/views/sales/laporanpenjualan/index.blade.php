            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        ...
                        <form method="GET" action="{{ route('sales.laporanpenjualan.index') }}" class="form-inline mb-3">
                            ...
                            <div class="d-flex justify-content-end ml-2">
                                <a href="{{ route('sales.laporanpenjualan.pdf', ['tanggal_awal' => $tanggalAwal, 'tanggal_akhir' => $tanggalAkhir]) }}"

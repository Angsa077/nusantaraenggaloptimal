            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        ...
                        <form method="GET" action="{{ route('supervisor.laporanpiutang.index') }}" class="form-inline mb-3">
                            <div class="d-flex justify-content-start">
                                <a href="{{ route('supervisor.laporanpiutang.pdf') }}"
                        ...
                        <table class="table table-hover" id="myTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item)
                                    ...
                                    @endphp
                                    <tr onclick="window.location='{{ route('supervisor.laporanpiutang.show', $item->kd_customer) }}';">

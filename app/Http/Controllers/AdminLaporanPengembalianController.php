...
class AdminLaporanPengembalianController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.laporanpengembalian.index', ['data' => $data, 'penjualan' => $penjualan, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir]);
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $html = view('admin.laporanpengembalian.pdf', ['data' => $data, 'penjualan' => $penjualan, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir]);

...
class AdminLaporanPenjualanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.laporanpenjualan.index', ['data' => $data, 'pengembalian' => $pengembalian, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir]);
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $html = view('admin.laporanpenjualan.pdf', ['data' => $data, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir])->render();
    ...
    public function show(Request $request)
    {
        ...
        $pdf = View::make('admin.laporanpenjualan.pdf', [
            'data' => $data,

...
class SalesLaporanPendapatanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('sales.laporanpendapatan.index', ['data' => $data, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir]);
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $html = view('sales.laporanpendapatan.pdf', ['data' => $data, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir])->render();
    ...
    public function show(Request $request)
    {
        ...
        $pdf = View::make('sales.laporanpendapatan.pdf', [
            'data' => $data,

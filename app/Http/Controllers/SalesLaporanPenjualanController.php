...
class SalesLaporanPenjualanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('sales.laporanpenjualan.index', ['data' => $data, 'pengembalian' => $pengembalian, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir]);
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $html = view('sales.laporanpenjualan.pdf', ['data' => $data, 'tanggalAwal' => $tanggalAwal, 'tanggalAkhir' => $tanggalAkhir])->render();
    ...
    public function show(Request $request)
    {
        ...
        $pdf = View::make('sales.laporanpenjualan.pdf', [
            'data' => $data,

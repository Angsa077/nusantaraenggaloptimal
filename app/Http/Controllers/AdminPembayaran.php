...
class AdminPembayaran extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminpembayaran.index')->with('success', 'Berhasil Mengisi Pembayaran');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('adminpembayaran.index')->with('success', 'Berhasil Menghapus Data Pembayaran');
    }
}

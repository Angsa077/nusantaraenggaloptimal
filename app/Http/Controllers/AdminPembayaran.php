...
class AdminPembayaran extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pembayaran.index', ['data' => $data, 'penjualan' => $penjualan]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.pembayaran.create', ['data' => $data, 'penjualan' => $penjualan]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pembayaran.index')->with('success', 'Berhasil Mengisi Pembayaran');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.pembayaran.index')->with('error', 'Berhasil Menghapus Data Pembayaran');
    }
}
